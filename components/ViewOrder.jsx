...
import { fetchOwnerIndoorBookings } from '../indoor-bookings';
...
const ViewOrder = () => {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        const ownerBookings = await fetchOwnerIndoorBookings();
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.header}>My Indoor Bookings</Text>
        {bookings.length === 0 ? (
